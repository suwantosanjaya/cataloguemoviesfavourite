...
public class UpcomingFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<Movies>> {
    static final String PILIHAN = "UPCOMING";
        ...
        try {
            ...
            buttonListener = new MovieAdapter.MovieDetailAdapterListener() {
                ...
                public void buttonDetailOnClick(View v, int position) {
                    UpcomingFragment.this.goToDetail(v, position);
                }

                @Override
                public void buttonShareOnClick(View v, int position) {
                    UpcomingFragment.this.goToShare(v, position);
                }
            };
