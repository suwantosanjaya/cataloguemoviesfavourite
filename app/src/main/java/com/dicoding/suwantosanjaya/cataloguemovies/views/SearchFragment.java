 ...
 */
public class SearchFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<Movies>> {
    static final String EXTRA_QUERY = "EXTRA_QUERY";
    static final String PILIHAN = "SEARCH";
        ...
        try {
            ...
            buttonListener = new MovieAdapter.MovieDetailAdapterListener() {
                ...
                public void buttonDetailOnClick(View v, int position) {
                    SearchFragment.this.goToDetail(v, position);
                }

                @Override
                public void buttonShareOnClick(View v, int position) {
                    SearchFragment.this.goToShare(v, position);
                }
            };
    ...
    public Loader<ArrayList<Movies>> onCreateLoader(int i, @Nullable Bundle bundle) {
        return new DataLoader(view.getContext(), PILIHAN, this.query);
    }
